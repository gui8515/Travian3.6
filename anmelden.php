...
<table cellpadding="1" cellspacing="1" id="sign_select">
	<tbody>
		<tr class="top">
			<th><img src="img/x.gif" class="img_u06" alt="choose tribe" />
			<input style="display: none;" class="radio" type="radio" name="kid" value="0" checked="checked" />
		</th>
		</tr>
		<tr>
			<td>
				<label>
				<b><input class="radio" type="radio" name="vid" value="1" <?php echo $form->getRadio('vid',1); ?> />&nbsp;<?php echo ROMANS; ?></b>
					<ul class="characteristics">
						<li>Pode aumentar ou estender um edifício e um campo de recursos simultaneamente</li>
						<li>A Muralha da Cidade dá um bônus de defesa alto</li>
						<li>Os comerciantes podem transportar 500 unidades de recursos (16 campos/hora)</li>
						<li>Infantaria muito poderosa, cavalaria média</li>
						<li>O desenvolvimento é caro e leva muito tempo</li>
					</ul>
				</label>
			</td>
		</tr><tr>
			<td>
				<label>
				<b><input class="radio" type="radio" name="vid" value="2" <?php echo $form->getRadio('vid',2); ?> />&nbsp;<?php echo TEUTONS; ?></b>
					<ul class="characteristics">
						<li>Bônus de pilhagem: as fendas inimigas escondem apenas 80% da quantidade <br /> normal na versão 3.5 do Travian.</li>
						<li>A parede de terra é quase indestrutível, mas só dá um bônus mínimo de defesa</li>
						<li>Os comerciantes podem transportar 1000 unidades de recursos (12 campos/hora)</li>
						<li>Tropas baratas e rápidas que são excelentes saqueadores</li>
						<li>Defesa fraca</li>
					</ul>
				</label>
			</td>
			...
			<td>
				<label>
					<b><input class="radio" type="radio" name="vid" value="3" <?php echo $form->getRadio('vid',3); ?> />&nbsp;<?php echo GAULS; ?></b>
					<ul class="characteristics">
						<li>Bônus de velocidade: tropas mais rápidas do jogo</li>
						<li>A paliçada dá um bônus de defesa médio</li>
						<li>Os comerciantes podem transportar 750 unidades de recursos (24 campos/hora)</li>
						<li>Cranny é duas vezes maior</li>
						<li>Armas de cerco caras</li>
						<li>Colonos baratos</li>
					</ul>
				</label>
			</td>
		</tr>
